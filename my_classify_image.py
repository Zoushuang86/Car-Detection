...
model_dir = 'G:/final_data/Car-detection/classification/freezed_car_graph_109064.pb'
label_file = 'G:/final_data/Car-detection/labels.txt'
...
def run_inference_on_image(image):
  ...
  with tf.Session() as sess:
    ...
    # Resize the image to (1, 299, 299, 3) to fit the net.
    image_data = tf.image.resize_images(image, (299, 299), 0)
    image_data = load_image_into_numpy_array(image_data.eval())
    ...
    predictions = sess.run(softmax_tensor,{'input:0': image_np_expanded})
